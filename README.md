...
> [!TIP]
> You can use same .venv for TDDepthAnything & TouchDiffusion. Look into accelerate.bat at 10 & 29 line. Same with TouchDesigner extension, on settings page set path to TouchDiffusion folder.
